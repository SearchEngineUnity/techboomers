                ...
                <Collapse in={openShoppingOnline} timeout="auto" unmountOnExit>
                  ...
                  >
                    ...
                    <li
                      ...
                      role="treeitem"
                    >
                      <a href="https://techboomers.com/c/online-shopping-sites-apps">View All ‣</a>
                    </li>
                  </ul>
                </Collapse>
              </li>
                ...
                <Collapse in={openOnlineEntertainment} timeout="auto" unmountOnExit>
                  ...
                  >
                    ...
                    <li
                      ...
                      role="treeitem"
                    >
                      <a href="https://techboomers.com/c/entertainment-websites-apps">View All ‣</a>
                    </li>
                  </ul>
                </Collapse>
              </li>
                          ...
                          >
                            <div className="row card horizontal collapse card-medium">
                              ...
                              <div className="column small-12 medium-8">
                                ...
                                <div className="card-section">
                                  <h5>
                                    9 Amazon Alternatives in Thailand for Great Deals On Everything
                                  </h5>
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            <div className="row card horizontal collapse card-medium">
                              ...
                              <div className="column small-12 medium-8">
                                <div className="card-divider category-blue" />
                                <div className="card-section">
                                  <h5>21 Websites Like Amazon in Singapore for Shopping Online</h5>
                                </div>
                              </div>
                            </div>
                          </a>
                  ...
                  >
                    <div className="column medium-4 large-3">
                      ...
                      <ul className="popular-courses">
                        ...
                        <li>
                          <a href="https://techboomers.com/p/candy-crush-saga">Candy Crush Saga</a>
                        </li>
                        <li>
                        ...
                        <div className="column medium-6 large-4 xlarge-3">
                          ...
                          >
                            <div className="card card-tall">
                              ...
                              />
                              <div className="card-section">
                                <h5>Spotify vs. Apple Music: A Music Streaming Service Showdown</h5>
                              </div>
                            </div>
                          </a>
                        </div>
                          ...
                          >
                            <div className="row card horizontal collapse card-medium">
                              ...
                              <div className="column small-12 medium-8">
                                ...
                                <div className="card-section">
                                  <h5>How to Block YouTube on Your Computer and Mobile Devices</h5>
                                </div>
                              </div>
                            </div>
                          </a>
                        ...
                        <div className="column medium-6 large-4 xlarge-3">
                          ...
                          >
                            <div className="card card-tall">
                              ...
                              <div className="card-section">
                                <h5>
                                  How to Find and Download Zoom Recordings: Local, Cloud, and Shared
                                </h5>
                              </div>
                            </div>
                          </a>
                  ...
                  >
                    <div className="column medium-4 large-3">
                      ...
                      <ul className="popular-courses">
                        ...
                        <li>
                          <a href="https://techboomers.com/p/internet-privacy">Internet Privacy</a>
                        </li>
                        <li>
                        ...
                        <div className="column medium-6 large-4 xlarge-3">
                          ...
                          >
                            <div className="card card-tall">
                              ...
                              />
                              <div className="card-section">
                                <h5>Twitter, Instagram, &amp; Pinterest: Social Media Mysteries</h5>
                              </div>
                            </div>
                          </a>
                        </div>
                        <div className="column medium-6 large-4 xlarge-3 show-for-large">
                          <a href="https://techboomers.com/data-privacy-day" className="card-link">
                            <div className="card card-tall">
                              <img
                                width="240"
                                height="150"
                              ...
                              <div className="card-section">
                                <h5>
                                  Guide to Data Privacy Day: What It Is and How to Stay Safe Online
                                </h5>
                              </div>
                            </div>
                          </a>
